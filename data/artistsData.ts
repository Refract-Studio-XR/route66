...
I served as the former curator of exhibitions at the Indian Pueblo Cultural Center in Albuquerque, New Mexico for 4 years. As an independent curator, exhibits installation entitled, "The Journey of Tamaya" at the Tamaya Hyatt Regency Resort & Spa, Santa Ana Pueblo. Current curated exhibition with local Native artists entitled, "Walls of Resilience - Indigenous Wisdom Confronting Planetary Crisis," with Native Mural Artists exhibition, Spring/Summer 2025, South Broadway Cultural Center-ABQ, NM.`,
  ...
  },
  {
    ...
    artistbio:
      "Lea Anderson, an installation and mixed media artist, has lived and worked in New Mexico for more than two decades and has discovered much during her adventures in the dramatic, colorful, and wild desert environment.\n\nAnderson has exhibited at the Albuquerque Museum and many galleries and exhibition spaces throughout New Mexico and the USA, as well as internationally in Bangkok, Thailand. She received her MFA in Painting and Drawing from UNM and has been teaching in higher education for more than 20 years. She has been a tenured Art Studio Faculty at Central New Mexico Community College (CNM) since 2011. She has curated local exhibitions for spaces such as 516 ARTS, Harwood Art Center, and Inpost Artspace in Albuquerque. She has been commissioned for collaborative projects with Meow Wolf in Houston and Electric Playhouse in New Mexico, as well as several New Mexico Public Art projects. Her work has inspired dozens of collaborative installation projects made by K-12 student artists world-wide, and she celebrates this as a true honor.\n\nShe is a proud supporter of her Albuquerque art community, mentoring local aspiring, emerging, and established artists through a variety of classes, mixed-media workshops, and creative projects.",
    additionalcredits: "",
    links: ["leadeniseanderson@gmail.com", "https://www.instagram.com/leaandersonart"],
  },
  {
    stop: "13",
