  ...
  return (
    <>
      ...
      >
        <SheetContent
          side="bottom"
          className="h-[40vh] rounded-t-2xl bg-black/50 backdrop-blur-md border border-white/20 p-0 [&>button]:hidden flex flex-col max-w-[480px] md:max-w-[640px] lg:max-w-[900px] mx-auto"
        >
